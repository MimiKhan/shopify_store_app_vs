...
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_all_collections_optimized.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_all_products_from_collection_by_id.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_all_products_on_query.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_collections_by_ids.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_product_recommendations.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_products_by_ids.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_shop.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_x_collections_and_n_products_sorted.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_x_products_after_cursor.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_x_products_after_cursor_within_collection.dart';
import 'package:shopify_store_app/shopify_models/graphql_operations/queries/get_x_products_on_query_after_cursor.dart';
import 'package:shopify_store_app/shopify_models/mixins/src/shopfiy_error.dart';
import 'package:shopify_store_app/shopify_models/models/src/collection/collections/collections.dart';
import 'package:shopify_store_app/shopify_models/models/src/product/product.dart';
import 'package:shopify_store_app/shopify_models/models/src/product/products/products.dart';
import 'package:shopify_store_app/shopify_models/models/src/shop/shop.dart';
...
class ShopifyStore with ShopifyError {
  ...
  /// Simply returns all Products from your Store.
  Future<List<Product>> getAllProductsSorted(
      {bool deleteThisPartOfCache = false,
        required SortKeyProduct sortKeyProduct}) async {
    List<Product> productList = [];
    Products tempProduct;
    String? cursor;
    WatchQueryOptions _options;
  ...
  Future<List<Product>> getAllProductsOnQuery(String query,
      {String? cursor, SortKeyProduct? sortKey,
      bool deleteThisPartOfCache = false,
      bool reverse = false}) async {
    String? cursor;
    List<Product> productList = [];
